...
(deftheme tangotango "A color theme based on Tango Palette colors.")
...
(let ((class '((class color) (min-colors 89)))
      ...
      (zenburn-orange+1 "#f57900")
      (zenburn-orange "orange")
      (zenburn-yellow+1 "#e9b96e")
      (zenburn-yellow "#edd400")
      (zenburn-yellow-1 "#fce94f")
      ;; (zenburn-green-1 "#5f7f5f")
      (zenburn-green "#6ac214")
      (zenburn-green+1 "#73d216")
      (zenburn-green+2 "#8ae234")
      ;; (zenburn-green+3 "#afd8af")
      ;; (zenburn-green+4 "#bfebbf")
      ;; (zenburn-cyan "#93e0e3")
      ;; (zenburn-blue+1 "#94bff3")
      (zenburn-blue "dodger blue")
      ;; (zenburn-blue-1 "#7cb8bb")
      (zenburn-blue-2 "#729fcf")
      ;; (zenburn-blue-3 "#5c888b")
      ;; (zenburn-blue-4 "#4c7073")
      (zenburn-blue-5 "dark slate blue")
      (zenburn-magenta "#ad7fa8")
      (zenburn-brown "brown4")
      )
  (custom-theme-set-faces
   'tangotango
   '(button ((t (:underline t))))
   `(link ((,class (:foreground ,zenburn-blue :underline t :weight bold))))
   `(link-visited ((,class (:foreground ,zenburn-blue-2 :underline t :weight normal))))

   ;;; basic coloring
   `(default ((,class (:foreground ,zenburn-fg :background ,zenburn-bg))))
   `(cursor ((,class (:foreground ,zenburn-yellow-1 :background ,zenburn-bg-1))))
   `(escape-glyph-face ((,class (:foreground ,zenburn-red))))
   `(fringe ((,class (:foreground ,zenburn-fg :background ,zenburn-bg-2))))
   `(header-line ((,class (:foreground ,zenburn-yellow
                                       :background ,zenburn-bg-1
                                       :box (:line-width -1 :style released-button)))))
   `(highlight ((,class (:background ,zenburn-brown))))

   ;; faces used by isearch
   `(isearch ((,class (:foreground ,zenburn-bg+1 :background ,zenburn-orange+1))))
   `(isearch-fail ((,class (:foreground ,zenburn-bg+1 :background ,zenburn-red))))
   `(lazy-highlight ((,class (:foreground ,zenburn-bg+1 :background ,zenburn-yellow+1))))

   `(menu ((,class (:foreground ,zenburn-fg :background ,zenburn-bg))))
   `(minibuffer-prompt ((,class (:foreground ,zenburn-blue-2 :weight bold))))
   `(mode-line
     ((,class (:foreground ,zenburn-fg-1
                           :background ,zenburn-bg
                           :box (:line-width 1 :color nil :style released-button)))))
   `(mode-line-buffer-id ((,class (:foreground ,zenburn-orange :weight bold))))
   `(mode-line-inactive
     ((,class (:foreground ,zenburn-fg-1
   ...
   ;;; font lock
   `(font-lock-builtin-face ((,class (:foreground ,zenburn-blue-2))))
   `(font-lock-comment-face ((,class (:foreground ,zenburn-bg+5))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,zenburn-green))))
   `(font-lock-constant-face ((,class (:foreground ,zenburn-green+2))))
   `(font-lock-doc-face ((,class (:foreground ,zenburn-bg+5))))
   `(font-lock-doc-string-face ((,class (:foreground ,zenburn-blue+1))))
   `(font-lock-function-name-face ((,class (:foreground ,zenburn-yellow))))
   `(font-lock-keyword-face ((,class (:foreground ,zenburn-blue-2 :weight bold))))
   `(font-lock-negation-char-face ((,class (:foreground ,zenburn-fg))))
   `(font-lock-preprocessor-face ((,class (:foreground ,zenburn-blue))))
   `(font-lock-string-face ((,class (:foreground ,zenburn-magenta :italic t))))
   `(font-lock-type-face ((,class (:foreground ,zenburn-green+2))))
   `(font-lock-variable-name-face ((,class (:foreground ,zenburn-orange+1))))
